...
> 📖 **[用户手册 (Word)](docs/memory_transplant_user_guide.docx)** — macOS / Windows 安装教程、完整使用流程、FAQ、故障排除

## 快速开始

### 方法一：直接使用（推荐）

访问在线版本：[memorytransplant.com](https://memory-transplant-20260319153048.netlify.app) *(部署后更新链接)*
